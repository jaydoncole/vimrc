...
class ZipArchive implements Countable
{
	...
	/*. string .*/ function getFromName(/*. string .*/ $entryname, $length = 0, $flags = 0){}
...
/*. if_php_ver_7 .*/
	/*. bool .*/ function setCompressionIndex(/*. int .*/ $index, /*. int .*/ $comp_method, $comp_flags = 0){}
	/*. bool .*/ function setCompressionName(/*. string .*/ $name, /*. int .*/ $comp_method, $comp_flags = 0){}
/*. end_if_php_ver .*/
