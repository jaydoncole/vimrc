 ...
 * @version $Date: 2018/06/01 14:28:16 $
 */
class Symbol extends Enum {
	 ...
	 * have to be shared by PHP 5 and 7 but with some minor differences.
	 */
	public static /*. Symbol .*/ $sym_x_if_php_ver_5;
		
	/**
	 * Reserved meta-code keyword <code>if_php_ver_7</code> that marks the
	 * beginning of a section of code for PHP 7 only. Used in modules that
	 * have to be shared by PHP 5 and 7 but with some minor differences.
	 */
	public static /*. Symbol .*/ $sym_x_if_php_ver_7;
	...
	public static /*. Symbol .*/ $sym_x_public, # public
	$sym_x_protected, # protected
	$sym_x_private, # private
	$sym_x_abstract, # abstract
	$sym_x_static, # static
	$sym_x_final, # final
	$sym_x_self, # self
	$sym_x_parent, # parent
	...
	/** Generics <code>?</code>. */
	public static /*. Symbol .*/ $sym_x_question; # >
	...
	/**
	 * Ellipsis in meta-code.
	 */
	public static /*. Symbol .*/ $sym_x_ellipsis;
...
Symbol::$sym_spaceship = new Symbol("sym_spaceship");
Symbol::$sym_coalesce = new Symbol("sym_coalesce");
...
Symbol::$sym_void = new Symbol("sym_void");
...
Symbol::$sym_ellipsis = new Symbol("sym_ellipsis");
...
Symbol::$sym_x_if_php_ver_7 = new Symbol("sym_x_if_php_ver_7");
...
Symbol::$sym_x_question = new Symbol("sym_x_question");

Symbol::$sym_x_docBlock = new Symbol("sym_x_docBlock");

Symbol::$sym_x_ellipsis = new Symbol("sym_x_ellipsis");
