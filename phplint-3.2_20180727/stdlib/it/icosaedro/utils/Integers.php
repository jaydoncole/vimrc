...
class Integers {
	...
	/**
	 * Returns the minimum among two int numbers.
	 * @param int $a
	 * @param int $b
	 * @return int Minimum among the two numbers.
	 */
	...
	/**
	 * Returns the maximum among two int numbers.
	 * @param int $a
	 * @param int $b
	 * @return int Maximum among the two numbers.
	 */
