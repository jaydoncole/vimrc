 ...
 * @version $Date: 2015/03/16 01:51:03 $
...
class FontTrueType extends Font {
	...
	private $glyphPos;
	/**
	 * Maps codepoint [0,65535] to glyph index [0,65535].
	 * @var int[int]
	 */
	private $charToGlyph;
	/**
	 * Maps glyph index [0,65535] into a list of all the codepoints that are
	 * represented by this same glyph.
	 * @var int[int][int]
	 */
	private $glyphToChar;
	private $ascent = 0.0;
	private $descent = 0.0;
	/**
	 * Family name, example: "Calligrapher".
	 * @var string
	 */
	private $familyName;
	/**
	 * Style name, example: "Regular".
	 * @var string
	 */
	private $styleName;
	/**
	 * Full name including family and style, example: "Calligrapher Regular".
	 * @var string
	 */
	private $fullName;
	/**
	 * Unique font identifier including owner, version, family and style,
	 * example "Altsys Fontographer 3.5  Calligrapher Regular".
	 * @var string
	 */
	...
	/**
	 * Returns true if this TrueType font is the same of the other. Comparison
	 * is made agains the file names these fonts were read from. On Windows this
	 * comparisong is made case-insensitive.
	 * @param object $other
	 * @return boolean
	 */
	...
	/**
	 * Returns the hash of this object calculated over the file name. On Windows
	 * this hash is case-insensitive.
	 * return int
	 */
	function getHash() {
	...
	/**
	 * Returns the name of this font as read from its defining file.
	 * @return string
	 */
	function __toString() {
		return $this->name;
	 ...
	 */
	function toUString() {
		return UString::fromASCII($this->__toString());
	}
...
//	}
	...
	private function getHMTX($numberOfHMetrics, $numGlyphs, &$glyphToChar, $scale) {
		...
		$aw = 0;
		$charWidths = array(0); // prepare entry 0
		$arr = /*. (int[int]) .*/ array();
