...
class testHashable extends TU {
	function run()
	{
		TU::test(Hash::hashOf(TRUE), 1);
		TU::test(Hash::hashOf(12345), 12345);
		TU::test(Hash::hashOf("aaaa"), -1382488763 & 0xffffffff);

		$a = new Guy("pippo", 46);
		$b = new Guy("pluto", 15);
		$c = new Guy("topolino", 15);
		$d = new Guy("paperino", 15);
		TU::test(Hash::hashOf($a), -551697894 & 0xffffffff);
		TU::test(Hash::hashOf($b), -1973144090 & 0xffffffff);
		TU::test(Hash::hashOf($c), 805508009);
		TU::test(Hash::hashOf($d), 503340547);
	}
}
