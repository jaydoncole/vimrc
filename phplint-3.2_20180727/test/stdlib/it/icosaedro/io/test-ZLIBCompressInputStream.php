...
//		echo "compressed: ", rawurlencode($compressed), "\n";
	...
	public function run()
	{
		...
		try {
			...
			if( $e->getMessage() === "E_WARNING: gzuncompress(): data error"
				&& PHP_VERSION_ID >= 70000 ){
				echo "Expected known bug: zlib stream compressor on empty data generates empty compressed on PHP >= 7 - see https://bugs.php.net/bug.php?id=71395\n";
			} else {
				throw $e;
			}
		}
